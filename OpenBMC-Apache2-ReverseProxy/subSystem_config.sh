...
# copy the httpd config files
   cp /usr/lib/python3.5/site-packages/Apache-ReverseProxy/httpd.conf /etc/apache2/httpd.conf
   cp /usr/lib/python3.5/site-packages/Apache-ReverseProxy/ssl.conf /etc/apache2/conf.d/httpd-ssl.conf
